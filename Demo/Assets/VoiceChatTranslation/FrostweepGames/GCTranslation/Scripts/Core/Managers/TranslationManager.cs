...
{
    public class TranslationManager : IServiceTranslation, IDisposable, ITranslationManager
    {
        ...
        private NetworkingTranslation _networking;
        ...
        public void Init()
        {
            ...
            _networking = new NetworkingTranslation();
        ...
        private void SendRequestInternal(string postData, Enumerators.GoogleCloudRequestType cloudRequestType)
        {
            ...
            NetworkEnumeratorsTranslation.RequestType requestType = NetworkEnumeratorsTranslation.RequestType.POST;
        ...
        private void NetworkResponseEventHandler(NetworkResponseTranslation response)
        {
